  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-3.5 opacity-65 transition-transform duration-150 [[data-state=open]_&]:rotate-180" />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-[min(360px,var(--radix-select-content-available-height))] min-w-[168px] max-w-[min(320px,calc(100vw-24px))] origin-(--radix-select-content-transform-origin) overflow-hidden rounded-[10px] border border-border bg-popover text-popover-foreground shadow-[var(--shadow-panel)]",
          position === "popper" &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "w-full min-w-[var(--radix-select-trigger-width)] p-1.5",
            position === "popper" &&
              "scroll-my-1"
          )}
        >
  ...
  return (
    ...
    >
      <span
        ...
        className="absolute right-2.5 flex size-4 items-center justify-center text-primary"
      >

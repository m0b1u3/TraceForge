...
describe("foundation store", () => {
  ...
  it("projects only protocol events belonging to the active Case and Run", () => {
    const started = {
      protocolVersion: 2 as const, id: "event_1", sequence: 1, runId: "run_1", caseId: "case_1",
      workId: null, turnId: "turn_1", role: "planner" as const, createdAt: "2026-08-25T12:00:00.000Z",
      method: "turn/started" as const, params: { agentInstanceId: "worker_1", sourceRunRevision: 1, sourceGraphRevision: null },
    };

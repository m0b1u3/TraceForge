...
createRoot(document.getElementById("root")!).render(<React.StrictMode>{desktop?.mode === "model-settings" ? <main className="settings-only"><header><span className="brand">TraceForge</span><span className="status">模型设置 · 不启动调查</span></header><ModelSettings bridge={desktop.modelSettings} /></main> : desktop?.conversations ? <HostWorkbench bridge={desktop.conversations} modelBridge={desktop.modelSettings} /> : <Workbench />}</React.StrictMode>);

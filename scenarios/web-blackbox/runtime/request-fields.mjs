...
export function experimentFields(request) {
    ...
    if (body !== undefined && Buffer.from(body, "base64").length > 65536)
        throw new Error("Experiment body exceeds 64 KiB");
    if (["GET", "HEAD"].includes(method) && (body || request.secretBody !== undefined))
